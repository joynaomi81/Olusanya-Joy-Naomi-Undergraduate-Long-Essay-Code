# -*- coding: utf-8 -*-
"""Whisper- small ASR Part 1

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SZXfWSwTYj3tTXh9t9bB5jTZk7bgXjAD
...
wandb.init(
    project="whisper-ASR-tone-yoruba-finetune",
    name="run-1",  # change name per experiment
    config={
...
def tone_error_rate(references, predictions):
    # A simple TER using jiwer, assuming tones are preserved in the strings
    # Customize preprocessing if needed (e.g., separate tones from base letters)
